import unittest
from graphlib import GrafoNaoDirMatrizAdj

class TestGrafoNaoDirMatrizAdj(unittest.TestCase):

    def setUp(self):
        # Grafo da Paraíba
        self.g_p = GrafoNaoDirMatrizAdj(['J', 'C', 'E', 'P', 'M', 'T', 'Z'])
        ...
        self.g_p_sem_paralelas = GrafoNaoDirMatrizAdj(['J', 'C', 'E', 'P', 'M', 'T', 'Z'])
        ...
        self.g_c = GrafoNaoDirMatrizAdj(['J', 'C', 'E', 'P'])
        ...
        self.g_c3 = GrafoNaoDirMatrizAdj(['J'])

        # Grafos com laco
        #self.g_l1 = GrafoNaoDirMatrizAdj(['A', 'B', 'C', 'D'], {'a1':'A-A', 'a2':'B-A', 'a3':'A-A'})
        self.g_l1 = GrafoNaoDirMatrizAdj(['A', 'B', 'C', 'D'])
        self.g_l1.adicionaAresta('A-A')
        self.g_l1.adicionaAresta('A-A')
        self.g_l1.adicionaAresta('B-A')

        #self.g_l2 = Grafo(['A', 'B', 'C', 'D'], {'a1':'A-B', 'a2':'B-B', 'a3':'B-A'})
        self.g_l2 = GrafoNaoDirMatrizAdj(['A', 'B', 'C', 'D'])
        self.g_l2.adicionaAresta('A-B')
        self.g_l2.adicionaAresta('B-B')
        self.g_l2.adicionaAresta('B-A')

        #self.g_l3 = GrafoNaoDirMatrizAdj(['A', 'B', 'C', 'D'], {'a1':'C-A', 'a2':'C-C', 'a3':'D-D'})
        self.g_l3 = GrafoNaoDirMatrizAdj(['A', 'B', 'C', 'D'])
        self.g_l3.adicionaAresta('C-A')
        self.g_l3.adicionaAresta('C-C')
        self.g_l3.adicionaAresta('D-D')

        #self.g_l4 = GrafoNaoDirMatrizAdj(['D'], {'a2':'D-D'})
        self.g_l4 = GrafoNaoDirMatrizAdj(['D'])
        self.g_l4.adicionaAresta('D-D')

        #self.g_l5 = GrafoNaoDirMatrizAdj(['C', 'D'], {'a2':'D-C', 'a3':'C-C'})
        self.g_l5 = GrafoNaoDirMatrizAdj(['C', 'D'])
